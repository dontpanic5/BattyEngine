...
emar rcs build\battyenginelib.a AnimationMgr.o BattyEngine.o ControllerMgr.o Entity.o EntityMgr.o EnvironmentalObject.o GameCamera.o Ground.o LevelMgr.o Ui.o BattyUtils.o