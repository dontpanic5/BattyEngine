...
emar rcs build\battyenginelib.a AnimationMgr.o AudioMgr.o BattyEngine.o BattyUtils.o ControllerMgr.o Entity.o EntityMgr.o EnvironmentalObject.o GameCamera.o Ground.o LevelMgr.o Ui.o